...
export default class PrivacyPolicyInfo extends React.Component {
    render() {
        return (
            ...
            <div className="container">
               <div className="row">
                  <div className="col-sm-12">
                     <div className="mt-2 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Terms of Use - Vizion Installment</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >General</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Permitted Use and Restrictions</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Your Access to the Site</h4>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                     </div>
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Accounts & Passwords</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Security</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Unauthorized Use of the Site</h4>
                        <p>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                     </div>
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >No Financial Advice Provided</h4>
                     ...
                     <div className="mt-5 wow fadeInUp">
                        <h4 className="iq-fw-8 mb-2" >Cookies</h4>

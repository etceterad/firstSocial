            ...
            >
              {({ values, errors, touched, handleChange, handleBlur, isValid, handleSubmit, dirty }) => (
                <form className="position-relative subscribe-form mt-5 mt-lg-0">
                  <div className="form-group mb-0">
                    <input 
                      type="email"
                      name="email" 
                      className={touched.email ? errors.email ? "form-control footer-form position-relative subscription-email mb-0 touched-input" : "form-control footer-form position-relative subscription-email mb-0" : "form-control footer-form position-relative subscription-email mb-0"} 
                ...
                <a
                  href=" "
                  role="button"
                  className="slide-button button bt-subscribe subscription-button "

...
export default class PricingListItem extends React.Component {

    render() {
        const {activateModal, pricingListImg, optionContentMarketing, optionConsulting, optionVideoMarketing, itemName, itemPrice} = this.props;
